    ...
    <!-- End Head -->
        ...
        <div class="s-swiper js__swiper-one-item">
            ...
            <div class="swiper-wrapper">
                <div class="g-fullheight--xs g-bg-position--center swiper-slide imageGray" style="background: url('img/1920x1080/02.jpg');">
                    <div class="container g-text-center--xs g-ver-center--xs">
                        <div class="g-margin-b-30--xs">
                            <h1 class="g-font-size-35--xs g-font-size-45--sm g-font-size-55--md g-color--white">The power of the web is in<br> your universality</h1>
                        </div>
                ...
                <div class="g-fullheight--xs g-bg-position--center imageGray swiper-slide 
        ...
        <div id="js__scroll-to-section" class="container g-padding-y-80--xs g-padding-y-125--sm">
            <div class="g-text-center--xs g-margin-b-100--xs">
                <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-margin-b-25--xs">Welcome to BCe</p>
                <h2 class="g-font-size-32--xs g-font-size-36--md">We Create Beautiful Experiences <br> functional and accessible to all audiences</h2>
            </div>
                ...
                <div class="col-sm-4 g-margin-b-60--xs g-margin-b-0--md">
                    <div class="clearfix">
                        ...
                        <div class="g-media__body g-padding-x-20--xs">
                            ...
                            <p class="g-margin-b-0--xs">We have developed amicable applications for all types of devices.</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 g-margin-b-60--xs g-margin-b-0--md">
                    <div class="clearfix">
                        ...
                        <div class="g-media__body g-padding-x-20--xs">
                            <h3 class="g-font-size-18--xs">Accessible Digital Media</h3>
                            <p class="g-margin-b-0--xs">Websites, hot-sites, e-books, digital evites, and more.</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="clearfix">
                        ...
                        <div class="g-media__body g-padding-x-20--xs">
                            <h3 class="g-font-size-18--xs">Perfect Pixel</h3>
                            <p class="g-margin-b-0--xs">We developed the code perfectly as show in the layout.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-4 g-margin-b-60--xs g-margin-b-0--md">
                    <div class="clearfix">
                        ...
                        <div class="g-media__body g-padding-x-20--xs">
                            <h3 class="g-font-size-18--xs">For all screen readers</h3>
                            <p class="g-margin-b-0--xs">Consistency and understanding of content using the screen readers.</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 g-margin-b-60--xs g-margin-b-0--md">
                    <div class="clearfix">
                        ...
                        <div class="g-media__body g-padding-x-20--xs">
                            <h3 class="g-font-size-18--xs">Adjusted Texts</h3>
                            <p class="g-margin-b-0--xs">Creation of adjusted texts to the language of digital media.
</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="clearfix">
                        ...
                        <div class="g-media__body g-padding-x-20--xs">
                            <h3 class="g-font-size-18--xs">Cross-Browser Applications</h3>
                            <p class="g-margin-b-0--xs">We create your website accessible and compatible for all browsers.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Parallax -->
        <div class="js__parallax-window imageGray" style="background: url(img/1920x1080/03.jpg) 50% 0 no-repeat fixed;">
            <div class="container g-text-center--xs g-padding-y-80--xs g-padding-y-125--sm">
                <div class="g-margin-b-80--xs">
                    <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md g-color--white">What is an accessible website?</h2>
                </div>
                <a href="faq.php" class="text-uppercase s-btn s-btn--md s-btn--white-brd g-radius--50">Learn More</a>
            </div>
        </div>
        <!-- End Parallax -->
                ...
                <div class="row">
                    <div class="col-md-4 g-margin-t-15--xs g-margin-b-60--xs g-margin-b-0--lg">
                        ...
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
                            <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md">BCe</h2>
                        </div>
                    </div>
                    <div class="col-md-4 col-md-offset-1">
                        <p class="g-font-size-18--xs">It is a project that has founded in the common vision of their members the need to create accessible solutions on the web that encompasses a specific corporate universe that is extremely important for enriching and harnessing the potential of people with disabilities.</p>
                        <p class="g-font-size-18--xs">Our goal is to make the web accessible to everyone. Using high technology and standards of references like W3C, we develop applications accessible to all people.</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-3 g-promo-section__img-right--lg g-bg-position--center g-height-100-percent--md js__fullwidth-img imageGray">
                <img class="img-responsive imageGray " src="img/970x970/03.jpg" alt="Image">
            </div>
        </div>
        <!-- End Culture -->
        ...
        <!-- Testimonials -->
        <div class="js__parallax-window imageGray" style="background: url(img/1920x1080/04.jpg) 50% 0 no-repeat fixed;">
            <div class="container g-text-center--xs g-padding-y-80--xs g-padding-y-125--sm">
                ...
                <div class="s-swiper js__swiper-testimonials">
                    ...
                    <div class="swiper-wrapper g-margin-b-50--xs">
                        <div class="swiper-slide g-padding-x-130--sm g-padding-x-150--lg">
                            <div class="g-padding-x-20--xs g-padding-x-50--lg">
                                <div class="g-margin-b-40--xs">
                                    <p class="g-font-size-22--xs g-font-size-28--sm g-color--white"><i>Como desenvolver um site acessível; Acessibilidade web para cegos, baixa visão, daltônicos, surdos, pessoas com pouca ou nenhuma destreza manual e sem deficiências; acessibilidade no (X)HTML, CSS e scripts para o bom funcionamento das tecnologias assistivas;</i></p>
                                </div>
                        ...
                        <div class="swiper-slide g-padding-x-130--sm g-padding-x-150--lg">
                            <div class="g-padding-x-20--xs g-padding-x-50--lg">
                                <div class="g-margin-b-40--xs">
                                    <p class="g-font-size-22--xs g-font-size-28--sm g-color--white"><i>"A web fez nascer um novo mundo, mais democrático, colaborativo, interativo, criativo e compartilhado, que pode ser ainda melhor com a igualdade de condições para seu acesso. "</i></p>
                                </div>
                                <div class="center-block g-hor-divider__solid--white-opacity-lightest g-width-100--xs g-margin-b-30--xs"></div>
                                <h4 class="g-font-size-15--xs g-font-size-18--sm g-color--white-opacity-light g-margin-b-5--xs"></h4>
                            </div>
        ...
        <!-- Counter -->
        <div class="js__parallax-window imageGray" style="background: url(img/1920x1080/06.jpg) 50% 0 no-repeat fixed;">
            <div class="container g-padding-y-80--xs g-padding-y-125--sm">
                <div class="row">
                    ...
                    <div class="col-md-3 col-xs-6 g-full-width--xs g-margin-b-70--xs g-margin-b-0--lg">
                        <div class="g-text-center--xs">
                            <figure class="g-display-block--xs g-font-size-70--xs g-color--white g-margin-b-10--xs js__counter">300</figure>
                            <div class="center-block g-hor-divider__solid--white g-width-40--xs g-margin-b-25--xs"></div>
                            <h4 class="g-font-size-18--xs g-color--white">Cup of coffee</h4>
                        </div>
                    </div>
        ...
        <section class="s-google-map">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5205.604422402662!2d-123.12408821764008!3d49.280144935538274!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x5486717f41ba2fb1%3A0xc6952794560a44aa!2sDowntown+Vancouver%2C+Vanc%C3%B4ver%2C+BC!5e0!3m2!1spt-BR!2sca!4v1519976580755"  height="500" frameborder="0" style="border:0; width: 100% !important" allowfullscreen></iframe>
        </section>
        <!-- End Google Map -->
        <!--========== END PAGE CONTENT ==========-->
