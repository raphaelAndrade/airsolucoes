                    ...
                    <div class="s-header__navbar-row">
                        <div class="s-header__navbar-row-col">
                            ...
                            <div class="s-header__logo">
                                ...
                                <a href="#" class="triggerContrast">Contrast</a>
                                <a href="#" class="triggerMoreClose">more close</a>
                                <a href="#" class="triggerResetClose">Reset close</a>
                            </div>
                            <!-- End Logo -->
                        </div>
                        <div class="s-header__navbar-row-col">
                ...
                <nav class="s-header__nav js__scrollbar">
                    <div class="container-fluid">
                        ...
                        <ul class="list-unstyled s-header__nav-menu">
                            ...
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="faq.php">O que é acessibilidade?</a></li>
